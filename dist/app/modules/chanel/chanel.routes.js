...
router.post("/create/:groupId", fileUploader_1.fileUploader.uploadChanelImage, parseBodyData_1.parseBodyData, (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.SUPER_ADMIN), chanel_controller_1.chanelControllers.createChanel);
router.get("/", (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.SUPER_ADMIN), chanel_controller_1.chanelControllers.getAllChanels);
